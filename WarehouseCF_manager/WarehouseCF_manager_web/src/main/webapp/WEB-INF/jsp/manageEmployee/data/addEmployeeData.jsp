...
<%--<form id="addForm" method="post" onsubmit="return saveReport();">--%>
...
<form id="addForm" method="post">
    ...
    <div>
        <a href="#" class="easyui-linkbutton" plain="true" style="background-color: #6a6a6a;color: #ffffff" onclick="doAdd()">添加</a>
    </div>
